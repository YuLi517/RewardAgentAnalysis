...
// v1.0.5: 4 个 GlowCard 的 input/select 表单 (受控组件, 同步到 formState)
// 替换 BeamCard (BorderBeam 1.3 光带太弱) → GlowCard (纯 CSS conic-gradient 旋转光带)
